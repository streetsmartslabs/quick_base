...
module QuickBase
  ...
  class Generated7
    ...
    def valid?
      ...
      field_type_validator = EnumAttributeValidator.new('String', ['text', 'text-multiple-choice', 'text-multi-line', 'rich-text', 'numeric', 'currency', 'rating', 'percent', 'multitext', 'email', 'url', 'duration', 'date', 'datetime', 'timestamp', 'timeofday', 'checkbox', 'user', 'multiuser', 'address', 'phone'])
    ...
    def field_type=(field_type)
      validator = EnumAttributeValidator.new('String', ['text', 'text-multiple-choice', 'text-multi-line', 'rich-text', 'numeric', 'currency', 'rating', 'percent', 'multitext', 'email', 'url', 'duration', 'date', 'datetime', 'timestamp', 'timeofday', 'checkbox', 'user', 'multiuser', 'address', 'phone'])
    ...
    def hash
      [audited, field_help, bold, properties, appears_by_default, field_type, permissions, add_to_forms, label, find_enabled, no_wrap].hash
    end
