...
module QuickBase
  class ReportsQueryFormulaFields
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'decimalPrecision')
        self.decimal_precision = attributes[:'decimalPrecision']
      end
    end
    ...
    def valid?
      field_type_validator = EnumAttributeValidator.new('String', ['rich-text', 'text', 'numeric', 'currency', 'percent', 'rating', 'date', 'timestamp', 'timeofday', 'duration', 'checkbox', 'phone', 'email', 'user', 'multiuser', 'url'])
    ...
    def field_type=(field_type)
      validator = EnumAttributeValidator.new('String', ['rich-text', 'text', 'numeric', 'currency', 'percent', 'rating', 'date', 'timestamp', 'timeofday', 'duration', 'checkbox', 'phone', 'email', 'user', 'multiuser', 'url'])
    ...
    def hash
      [id, label, field_type, formula, decimal_precision].hash
    end
