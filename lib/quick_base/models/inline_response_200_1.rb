...
module QuickBase
  class InlineResponse2001
    ...
    # The type of report in Quick Base (e.g., chart).
    attr_accessor :type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'usedLast')
        self.used_last = attributes[:'usedLast']
      end

      if attributes.has_key?(:'usedCount')
        self.used_count = attributes[:'usedCount']
      end
    end
    ...
    def hash
      [id, name, type, description, owner_id, query, properties, used_last, used_count].hash
    end
