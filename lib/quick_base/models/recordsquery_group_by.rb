...
module QuickBase
  class RecordsqueryGroupBy
    ...
    def valid?
      grouping_validator = EnumAttributeValidator.new('String', ['ASC', 'DESC', 'equal-values'])
      return false unless grouping_validator.valid?(@grouping)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] grouping Object to be assigned
    def grouping=(grouping)
      validator = EnumAttributeValidator.new('String', ['ASC', 'DESC', 'equal-values'])
