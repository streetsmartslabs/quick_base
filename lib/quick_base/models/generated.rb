...
module QuickBase
  ...
  class Generated
    ...
    def self.swagger_types
      {
        :'assign_token' => :'BOOLEAN',
        :'variables' => :'Array<AppsVariables>',
        :'name' => :'String',
        :'description' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assignToken')
        self.assign_token = attributes[:'assignToken']
      end
    ...
    def hash
      [assign_token, variables, name, description].hash
    end
